...
![Netlify Next.js Blog Template designed by Bejamas](media/github-banner.svg)
...
![Preview of blog theme. Author named Jay Doe and blog's name is "Next.js Blog Theme" with one blog post](media/nextjs-blog-theme-preview.png)
...
![Preview of Setup Wizard showing the initial page of a setup form](media/nextjs-setup-wizard.png)
