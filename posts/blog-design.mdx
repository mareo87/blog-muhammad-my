...
![Netlify Next.js Blog Template designed by Bejamas](https://www.dropbox.com/s/78gg1cyt5sifbmp/github-banner.svg)
...
![Preview of blog theme. Author named Jay Doe and blog's name is "Next.js Blog Theme" with one blog post](https://www.dropbox.com/s/k00kcsmxgabd8o3/nextjs-blog-theme-preview.png)
...
Open your browser and visit localhost, your project should be running!

### Using the Setup Wizard

![Preview of Setup Wizard showing the initial page of a setup form](https://www.dropbox.com/s/9fb4bpw2pdh92ca/nextjs-setup-wizard.png?dl=0)
